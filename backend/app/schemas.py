...
class CardBase(BaseModel):
    ...
    gap_fill: Optional[str] = Field(None, max_length=500, description="Фраза с пропущенным ключевым словом")
...
class CardCreate(BaseModel):
    ...
    keyword: Optional[str] = Field(None, max_length=100, description="Ключевое слово")
    gap_fill: Optional[str] = Field(None, max_length=500, description="Фраза с пропущенным ключевым словом")
