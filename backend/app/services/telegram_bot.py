...
2️⃣ Создайте свою первую колоду, выбрав язык изучения и язык перевода
3️⃣ Напишите или вставьте фразу для изучения
4️⃣ Ведите ключевое слово из этой фразы, которое вы хотите запомнить
5️⃣ Далее создаются фразы с ключевым словом в разных формах
