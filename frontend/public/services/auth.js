    ...
    async initialize() {
        try {
            ...
            if (typeof window.Telegram === 'undefined' || !window.Telegram.WebApp) {
                console.warn('[Auth] Telegram WebApp API недоступен, используем режим разработки');
            ...
            if (!initDataUnsafe.user) {
                console.warn('[Auth] Данные пользователя недоступны в Telegram, используем режим разработки');
                return this.initializeDevelopmentMode();
            }
            ...
            console.warn('[Auth] Переключаемся на режим разработки');
            return this.initializeDevelopmentMode();
        }
    }

    /**
     * Инициализация в режиме разработки (без Telegram WebApp)
     * @returns {boolean} Результат инициализации
     */
    initializeDevelopmentMode() {
        try {
            console.log('[Auth] Initializing development mode...');
            ...
            this.telegramWebApp = {
                ...
                close: () => console.log('[Auth] WebApp close called')
            };
            
            this.isInitialized = true;
            this.updateStatus('Режим разработки активирован');
            
            return true;
            
        } catch (error) {
            console.error('[Auth] Development mode initialization failed:', error);
